...
export const Chart: FC = () => {
  ...
  const initDrag = (eChart) => {
    ...
    eChart.getZr().on('mousemove', (event) => {
      ...
      // Move _draggingEl.
      _draggingEl.attr('x', _draggingCursorOffset[0] + cursorX);
      _draggingEl.attr('y', _draggingCursorOffset[1] + cursorY);
    ...
    const dragRelease = () => {
      ...
      if (_draggingEl) {
        eChart.getZr().remove(_draggingEl);
        _draggingEl = null;
      }
      if (_dropShadow) {
        eChart.getZr().remove(_dropShadow);
        _dropShadow = null;
      }
    ...
    const updateRawData = (params) => {
      ...
      const arr = _rawData.flight.dimensions.map((dimension: string, index: number) => ({
        dimension,
